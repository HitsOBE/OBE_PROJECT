...
$pdf->Cell(0,50,'COURSE DELIVARY PLAN',0,0,'C');


$pdf->SetFont('Arial','B',12);
$pdf->Setx($pdf->lMargin);
$pdf->Cell(0,100,"                                               ".'Course name:',0,0,'L');

$pdf->Setx($pdf->lMargin);
$pdf->cell(45,100,"                                                                         ".$row["course_code"],0,0,'L');
...
$pdf->SetFont('Arial','B',12);
$pdf->Setx($pdf->lMargin);
$pdf->Cell(0,80,"                                                                                       ".'Department:',0,0,'L');
$pdf->Setx($pdf->lMargin);
$pdf->cell(35,80,"                                                                                                              ".$row1["department"],0,0,'L');
