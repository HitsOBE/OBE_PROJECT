                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>topic</th>
                                            <th>pertaining co</th>
                                            <th>pertaining btl</th>
                                            <th>tlo</th>
                                            <th>method activity</th>
                                            <th>assesment tlo</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
							                   ...
							                   foreach($pdo->query($sql) as $row)
							                   {
                                                        ...
                                                        echo '<td>'. $row['pertaining_co'] . '</td>';
                                                        echo '<td>'. $row['pertaining_btl'] . '</td>';
                                                        echo '<td>'. $row['tlo'] . '</td>';
                                                        echo '<td>'. $row['method_activity'] . '</td>';
                                                        echo '<td>'. $row['assessment_tlo'] . '</td>';
