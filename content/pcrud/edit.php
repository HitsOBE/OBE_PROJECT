...
if ( $id==null) {
      $pro = $_GET['cc'];
        header("Location: ../../PEO.php?peo=".$pro."");
    }
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "UPDATE peo set faculty_code = ? ,depart_code = ?,programme_code = ?,peo_code = ?,peo_desc = ? WHERE id = ?";
            $q = $pdo->prepare($sql);
...
<div class="span10 offset1">
                    <div class="row">
                        <h3>Edit Programme Educational Outcome</h3>
                    </div>
                    <?php
                    $sql1 = mysql_query("SELECT peo_code, peo_desc from peo where id ='".$_GET['id']."' ");
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="control-group <?php echo !empty($rangeError)?'error':'';?>">
                        ...
                        <option disabled selected value="">Your Previous Selection was <?php echo $row['peo_code']; ?></option>
                      ...
                      <div class="control-group <?php echo !empty($outcomeError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <textarea name="peo" required type="text" class="form-control" style="width:300px" placeholder="Programme Educational Outcome" value=""><?php echo $row['peo_desc']; </textarea>
                      ...
                      <div class="form-actions" style="margin-top:20px;">
                          ...
                          <?php $program = $_GET['cc'];
                           echo "<a class='btn' href='../../PEO.php?pro=$program'>Back</a>"; ?>
                        </div>
                    </form>
                </div>
     </div>
