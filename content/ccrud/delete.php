...
<body>
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    if ( !empty($_POST)) {
        ...
        $sql = "DELETE FROM co WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($id));
        $sql1 = "DELETE FROM co_po_mapping WHERE co_code = '".$_GET['co']."' && course_code = '".$_GET['pro']."'";
        $q1 = $pdo->prepare($sql1);
        $q1->execute(array($id));
        Database::disconnect();
        $pro = $_GET['pro'];
        header("Location: ../../CourseOutcomes.php?pro=$pro");
    }
?>

<div class="span10 offset1">
                    <div class="row">
                        <h3>Delete Course Outcome</h3>
                    </div>
                  ...
                  <?php  echo "<form class='form-horizontal' action='' method='post'>"; ?>
                      ...
                      <div class="form-actions">
                          ...
                          <?php $pro = $_GET['pro']; ?>
                          <a class="btn" href="../../CourseOutcomes.php?pro=<?php echo $pro ?>">No</a>
                        </div>
                    </form>
                </div>
</div>
